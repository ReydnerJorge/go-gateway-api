...
// Account representa um conta com suas informações e saldo protegido para acessos concorrentes
type Account struct {
	ID        string
	Name      string
	Email     string
...
// AddBalance modifica o valor do saldo da conta de forma thread-safe
